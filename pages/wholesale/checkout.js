...
export default function WholesaleCheckoutPage() {
  ...
  // 3) guard: если пусто — подсказка вернуться на шаг 1
  ...
  // операции с корзиной (редактирование прямо на шаге 2)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Контент: мобильный-first, одна колонка */}
      <div className="mx-auto max-w-5xl px-4 py-4 grid gap-4 lg:grid-cols-5">
        ...
        <div className="lg:col-span-3">
          <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
            ...
            <div className="mt-3 grid gap-3">
              ...
              <textarea
                placeholder="Комментарий (условия доставки, время, примечания)"
                rows={4}
                value={form.comment}
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              <button
                ...
                className={
                  ...
                  (sending ? "bg-gray-200 text-gray-500" : "bg-gray-900 text-white hover:opacity-90")
                }
              >
        ...
        {/* Правая колонка: состав заказа (мобильная сверху, на десктопе справа) */}
      ...
      {/* Нижний закреп (мобайл): дублирование итогов и кнопки */}
      <div className="sticky bottom-0 z-30 border-t border-gray-200 bg-white/95 backdrop-blur">
        <div className="mx-auto max-w-5xl px-4 py-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            <a
              href="/wholesale/order"
              className="inline-flex items-center gap-2 rounded-xl border border-gray-300 bg-white px-3 py-1.5 text-sm"
            >
              <ArrowLeft size={16} />
              К товарам
            </a>
